...
void crearBitmapDeNodosConectados(char * NodoConectado,int cantBloques){
	...
	void crearBitmapXNodo(char * nodoConectado){
		...
		string_append(&PATH_bitmap_xNOdo,"/home/utnso/workspace/tp-2017-2c-Mi-Grupo-1234/filesystem/FileSystem/bitmaps/");
...
int main() {
	...
	configFs =config_create("/home/utnso/workspace/tp-2017-2c-Mi-Grupo-1234/config/configFilesystem.config");
